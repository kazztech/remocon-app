        ...
        <>
            <Container className={classes.container}>
                <Table aria-label="simple table">
                    <TableBody>
                        <TableRow>
                            <TableCell align="left" component="th">ラベルテキスト</TableCell>
                            <TableCell align="left">{inputWidgetLabelText}</TableCell>
                        </TableRow>
                        <TableRow>
                            <TableCell align="left" component="th">アイコンカラー</TableCell>
                            <TableCell align="left">{inputWidgetIconColor}</TableCell>
                        </TableRow>
                        <TableRow>
                            <TableCell align="left" component="th">アイコンスタイル</TableCell>
                            <TableCell align="left">{inputWidgetIconStyle}</TableCell>
                        </TableRow>
                        <TableRow>
                            <TableCell align="left" component="th">レイアウト</TableCell>
                            <TableCell align="left">{selectPosition}</TableCell>
                        </TableRow>
                        <TableRow>
                            <TableCell align="left" component="th">赤外線データ</TableCell>
                ...
                <Box className={`${classes.formGroup} ${classes.formSubmit}`}>
                    <Button
                        ...
                        component={Link}
                        to={{
                            pathname: `/edit/remocons/${remoconId}/widgets/${widgetId}/update/input`,
                            state: {
